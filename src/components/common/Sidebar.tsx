...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "p-6 flex items-center gap-4 overflow-hidden",
        ...
        >
          ...
          {!isCollapsed && (
            <div className="flex-1 min-w-0 animate-in fade-in">
              ...
              <p className="text-[11px] text-slate-400 font-medium truncate italic underline underline-offset-2">
                {user?.email}
              </p>
            </div>
          )}
